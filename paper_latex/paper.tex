...
\input{sections/experimental_paradigm.tex}
\input{sections/mlp_generalizations.tex}
\input{sections/cnn_generalizations.tex}
\input{sections/vocabulary_acceleration.tex}
\newpage
\input{sections/acknowledgements.tex}

% These are temporary... testing that bibliography looks good
\nocite{Harlow1949}
\nocite{Landau1988}
\nocite{Markman1988}
\nocite{Smith2002}
\nocite{GershkoffStowe2004}
\nocite{Kemp2007}
\nocite{Salakhutdinov2012}
\nocite{Ritter2017}
\nocite{Lake2017}
